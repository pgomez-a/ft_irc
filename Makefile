...
CMD_SRCS	=	$(addprefix ./command/, Command.cpp reply_system.cpp  mode_flags.cpp Error.cpp Part.cpp Join.cpp Nick.cpp Notice.cpp Oper.cpp Pass.cpp Privmsg.cpp Quit.cpp User.cpp Ping.cpp Cap.cpp List.cpp Topic.cpp Mode.cpp Names.cpp)
